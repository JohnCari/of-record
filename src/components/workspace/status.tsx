...
> = {
  verified: {
    label: "Verified",
    explain: "The quote is in the cited source and the source supports the sentence.",
    icon: CircleCheck,
    text: "text-verified",
    mark: "bg-verified",
  },
  blocked: {
    label: "Blocked",
    explain: "A check failed. This sentence cannot be filed as written.",
    icon: CircleX,
    text: "text-blocked",
    mark: "bg-blocked",
  },
  ...
  accepted: {
    ...
    explain: "You decided this sentence stays. Your reason is recorded.",
    icon: Gavel,
    text: "text-primary",
    mark: "bg-primary",
  },
  struck: {
    label: "Struck by you",
    explain: "You decided this sentence goes. Your reason is recorded.",
    icon: Gavel,
    text: "text-muted-foreground",
